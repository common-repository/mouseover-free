<?php
/* 
 * Plugin Name: MouseOver Free
 * Version: 1.2.3
 * Plugin URI: http://www.mouseoverplugin.com
 * Description: <a href="http://www.mouseoverplugin.com"><strong>Smart And Easy Way To Grab Your Visitors' Attention!</strong></a> On mouse hover, MouseOver Plugin will change images, text and links. You may use it in many ways: Navigation or sub-menu, Social tool bar, Buy / Download buttons, Portfolio, Image Gallery and more! <a href="http://mouseoverplugin.com">MouseOver Premium</a> version allows unlimited MouseOver's on your site, to place MouseOver's on pages, posts, widget and sidebars, Font settings (style, size, color and text background), Uploading background image and more! <a href="http://www.mouseoverplugin.com"><strong>>> Click NOW To Find Out More >></strong></a>
 * Author: GetAPlugin.com
 * Author URI: http://www.getaplugin.com
 * Text Domain: MouseOver-Free
...
if(is_admin()){
	...
	wp_register_script('mouseover-free-imageup',MOUSE_OVER_PATH.'/js/imageup.js', array('jquery','media-upload','thickbox'));
	wp_enqueue_script('mouseover-free-imageup');
 }
} 

function wpimageflip_admin_css() {
	wp_register_style('mouseover-free-style', MOUSE_OVER_PATH .'/css/style.css');
	wp_register_style('jquery-ui-css', MOUSE_OVER_PATH .'/css/jquery-ui-css.css');
	
	wp_enqueue_style('mouseover-free-style');
...
.image-flip-wrap {
	float:left;
 width:<?php echo get_option('pwidth');
?>px;
 min-height:<?php echo get_option('pheight');
?>px;
...
.image-flip-text {
	float:left;
 width:<?php echo get_option('textwidth');
?>px;
...
.flip-image {
	float:left;
 width:<?php echo get_option('imagedivwidth');
?>px;
}
.inner-flip-image-first {
	float:left;
 width:<?php echo get_option('imagewidth');
?>px;
	margin-right:5px;
}
...
<div class="wrap">
  ...
  <div class="flip-heading-free">
    <p> <img src="<?php echo MOUSE_OVER_PATH; ?>/images/MouseOver_logo.png" /><br />
      <span style="color:#2c7ca7;font-size:15px;font-weight:bold;"> <a href="http://www.getaplugin.com">Click to See Our Latest WP Plugins</a> </span> </p>
  </div>
  <div class="updated-fade-free">
    <p> <span style="color:#2c7ca7;font-size:15px;font-weight:bold;">Welcome to Mouse Over plugin admin area</span><br>
      <br>
      To add new MouseOver plugin, please click the <b>"Icon Settings" tab</b> and upload images, add text and links.<br>
      <b>"Plugin Settings" tab</b> provides with plugin size, background and text settings options.<br>
      ...
      Copy and paste the shortcode on necessary page or post.<br>
      <br>
      <b><span style="color:#2c7ca7;font-size:15px;font-weight:bold;">MouseOver Premium allows you to:</span></b> <br>
      + Create unlimited short-codes to place anywhere on your website<br>
      ...
      <span style="color:#2c7ca7;font-size:15px;font-weight:bold;"><a href="http://www.mouseoverplugin.com">Click Here NOW For Additional Features And To Upgrade!</a></span> </p>
  </div>
      ...
      <div id="tabs">
        ...
        <div id="tabs-1">
          ...
          <table>
            ...
            <tr>
              <td><label>Upload default Image</label>
              </td>
        ...
        <div id="tabs-2">
          ...
          <table>
            ...
            <tr>
              ...
              <td><input id='2' class="uploadbtn"  name='default_img_upload_btn2' type='button' value='Upload'/></td>
            </tr>
            <tr>
              <td><label>Upload Mouse-over Image</label></td>
              <td><input id='mouseover_img_id2' name='mouseover_img2' size='40' type='text' value='<?php echo get_option('mouseover_img2'); ?>' /></td>
              <td><input id='2' class="roluploadbtn" name='mouseover_img_upload_btn2' type='button' value='Upload' /></td>
            </tr>
            <tr>
              <td valign="top"><label>Insert Text</label></td>
...
<div class="image-flip-wrap">
  ...
  <div class="flip-image">
    <div class="inner-flip-image-first">
      ...
      <a href="<?php echo addhttpurl(get_option('image_url1')); ?>" <?php if(get_option('opennwindow1')=='yes'){ ?>target="_blank" <?php }else{?> target="_self" <?php }?> >
      <?php } ?>
      <img src="<?php echo get_option('default_img1'); ?>" title="<?php echo get_option('image_text1'); ?>" onmouseover="this.src='<?php echo get_option('mouseover_img1'); ?>'" onmouseout="this.src='<?php echo get_option('default_img1'); ?>'">
      <?php if(get_option('image_url1') != ' '){ ?>
      </a>
      <?php } ?>
    </div>
  ...
  <div class="flip-image" >
    <div class="inner-flip-image-second">
      ...
      <a href="<?php echo addhttpurl(get_option('image_url2')); ?>" <?php if(get_option('opennwindow2')=='yes'){ ?>target="_blank" <?php }else{?> target="_self" <?php }?> >
      <?php } ?>
      <img src="<?php echo get_option('default_img2'); ?>" title="<?php echo get_option('image_text2'); ?>" onmouseover="this.src='<?php echo get_option('mouseover_img2'); ?>'" onmouseout="this.src='<?php echo get_option('default_img2'); ?>'">
      <?php if(get_option('image_url2') != ''){ ?>
      </a>
      <?php } ?>
    </div>
  ...
  <div class="image-flip-text">
    ...
    <a href="<?php echo addhttpurl(get_option('image_url'.$leastno)); ?>" <?php if(get_option('opennwindow'.$leastno)=='yes'){ ?>target="_blank" <?php }else{?> target="_self" <?php }?> >
    <?php } ?>
    <?php echo get_option('image_text'.$leastno); ?>
    <?php if(get_option('image_url'.$leastno) != ''){ ?>
    </a>
    <?php } ?>
  </div>
